...
(let ((class '((class color) (min-colors 89)))
      ...
      (jazz-fg       "#c6a57b")      ; original foreground: #c6a57b
  ...
  (custom-theme-set-faces
   ...
   `(org-agenda-structure
     ((,class (:weight bold :foreground ,jazz-fg :background ,jazz-blue))))
   ...
   `(org-scheduled-previously ((,class (:foreground ,jazz-orange))))
   ...
   ;; eyebrowse
   `(eyebrowse-mode-line-inactive ((,class (:foreground ,jazz-bg+3))))
   `(eyebrowse-mode-line-active ((,class (:foreground ,jazz-fg))))

   ;; sml
   `(sml/modes       ((,class (:inherit sml/global :foreground ,jazz-fg :weight bold))))
   `(sml/minor-modes ((,class (:inherit sml/global :foreground ,jazz-green+4))))

   ;; which-func-mode
   `(which-func ((,class (:foreground ,jazz-green+4))))

   ;; highlight-indentation-mode
   `(highlight-indentation-face ((,class (:background ,jazz-bg+1))))

   `(artbollocks-face ((t (:underline t :foreground ,jazz-red-2))))
   `(artbollocks-passive-voice-face ((t (:underline t))))
   `(artbollocks-lexical-illusions-face ((t (:underline t :foreground ,jazz-orange))))
   `(artbollocks-weasel-words-face ((t (:underline t :foreground ,jazz-blue-1)))))
